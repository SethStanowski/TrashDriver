...
/*
 * This function will be called when we write teh Device file
 */
...
static int __init etx_driver_init(void) {
	...
	/*Create proc dicectory. It will create a directory under "/proc" */
	...
	/*Creating Proc entry under "/proc/etc/" */
